...
<form action="/addNewUser" style="border:1px solid #ccc" method="post">
    <div class="container">
        ...
        <input type="text" placeholder="Enter Name" name="login" value="AntonTest" required>

        <label for="email"><b>Email</b></label>
        <input type="text" placeholder="Enter Email" value="antons.zn@gmail.com" name="email" required>

        <label for="psw"><b>Password</b></label>
        <input type="password" placeholder="Enter Password" value="1" name="psw" required id="password">
